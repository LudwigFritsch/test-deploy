    ...
    return `
        <div class="manualContainer">
          ...
          <p>
            ...
            <div class="Button"> 
              <img src="/static/images/tiles/WTaste.png" height = "48px" width = "48px">
              • Hoch </br>
            </div>

            <div class="Button"> 
              <img src="/static/images/tiles/STaste.png" height = "48px" width = "48px">
              • Runter </br>
            </div>

            <div class="Button">
              <img src="/static/images/tiles/ATaste.png" height = "48px" width = "48px">
              • Links </br>
            </div>

            <div class="Button">
              <img src="/static/images/tiles/DTaste.png" height = "48px" width = "48px">
              • Rechts </br>
            </div>
            </br>
            ...
            <div class="Button">  
              <img src="/static/images/tiles/QTaste.png" height = "48px" width = "48px">
                • <div class="minus">
                    zum Dynamit legen (sprengt Steine in horizontaler und vertikaler Richtung) 
                  </div>
            </div>
          </p>
      </div>
